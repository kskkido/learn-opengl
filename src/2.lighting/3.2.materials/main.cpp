...
int main()
{
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    glUniform3fv(glGetUniformLocation(cubeShaderProgram, "light.ambient"), 1, glm::value_ptr(ambientColor));
    glUniform3fv(glGetUniformLocation(cubeShaderProgram, "light.diffuse"), 1, glm::value_ptr(diffuseColor));
