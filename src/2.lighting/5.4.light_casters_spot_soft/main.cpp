...
int main()
{
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    glUniform3fv(glGetUniformLocation(cubeShaderProgram, "light.position"), 1, glm::value_ptr(state.cameraPosition));
    glUniform3fv(glGetUniformLocation(cubeShaderProgram, "light.direction"), 1, glm::value_ptr(state.cameraFront));
    glUniform3fv(glGetUniformLocation(cubeShaderProgram, "light.ambient"), 1, glm::value_ptr(glm::vec3(0.2f, 0.2f, 0.2f)));
    glUniform3fv(glGetUniformLocation(cubeShaderProgram, "light.diffuse"), 1, glm::value_ptr(glm::vec3(0.5f, 0.5f, 0.5f)));
    glUniform3fv(glGetUniformLocation(cubeShaderProgram, "light.specular"), 1, glm::value_ptr(glm::vec3(1.0f, 1.0f, 1.0f)));
    glUniform1f(glGetUniformLocation(cubeShaderProgram, "light.cutOff"), glm::cos(glm::radians(12.5f)));
    glUniform1f(glGetUniformLocation(cubeShaderProgram, "light.outerCutOff"), glm::cos(glm::radians(17.5f)));
    glUniform1f(glGetUniformLocation(cubeShaderProgram, "light.constant"), 1.0f);
    glUniform1f(glGetUniformLocation(cubeShaderProgram, "light.linear"), 0.09f);
    glUniform1f(glGetUniformLocation(cubeShaderProgram, "light.quadratic"), 0.032f);
