...
int main()
{
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    glUniform3fv(glGetUniformLocation(cubeShaderProgram, "material.ambient"), 1, glm::value_ptr(glm::vec3(1.0f, 0.5f, 0.31f)));
    glUniform3fv(glGetUniformLocation(cubeShaderProgram, "material.diffuse"), 1, glm::value_ptr(glm::vec3(1.0f, 0.5f, 0.31f)));
