...
int main()
{
  ...
  std::vector<PointVertex> pointVertices = {
    PointVertex {.position = glm::vec3(-0.5f, 0.5f, 0.0f), .color = glm::vec3(1.0f, 0.0f, 0.0f) },
    PointVertex {.position = glm::vec3(0.5f, 0.5f, 0.0f), .color = glm::vec3(0.0f, 1.0f, 0.0f) },
    PointVertex {.position = glm::vec3(0.5f, -0.5f, 0.0f), .color = glm::vec3(0.0f, 0.0f, 1.0f) },
    PointVertex {.position = glm::vec3(-0.5f, -0.5f, 0.0f), .color = glm::vec3(1.0f, 1.0f, 0.0f) }
  };
  ...
  glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(PointVertex), (void*)(offsetof(PointVertex, color)));
