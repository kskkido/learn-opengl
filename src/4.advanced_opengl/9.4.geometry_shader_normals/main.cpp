...
int main()
{
  ...
  std::vector<unsigned int> normalShaders = {
    loadShader(staticFilePath / "normal.vert", GL_VERTEX_SHADER),
    loadShader(staticFilePath / "normal.geom", GL_GEOMETRY_SHADER),
    loadShader(staticFilePath / "normal.frag", GL_FRAGMENT_SHADER),
  };
  unsigned int normalShaderProgram = createShaderProgram(normalShaders);
  ModelLoadContext modelLoadContext = {
    .directory = staticFilePath / "models/backpack",
    .filename = staticFilePath / "models/backpack/backpack.obj",
    .textures = {}
  };
  Model backpack = loadModel(modelLoadContext);
  State state = State {
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    drawModel(backpack, shaderProgram);
    ...
    drawModel(backpack, normalShaderProgram);
